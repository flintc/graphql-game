...
import { CheckIcon, FilterIcon, XIcon } from "@heroicons/react/outline";
...
import { useKeyword } from "../../entities/keyword/useKeyword";
...
export const MovieFilters = ({ numResults }) => {
  return (
    <Drawer
      trigger={
...
export * from "./useMovieBrowse";

export * from "./useClientMovieBrowse";
